...
Unlike `sqrt`, the body of `cor` is quite long! This a very useful function that you'll use frequently in the future. Let's display the help page of `cor` using `?cor`
...
- You can look at the excellent Rstudio online [tutorials](https://rstudio.cloud/learn/primers)
