...
- You choose one value between $1$ and $6$ uniformly at random for the first roll. Let's say you end up with $3$. 
...
question("What is the quantile of order 50% of the sequence $\\{0, \\dots, 100, \\}$?", 
         ...
         answer("100"), 
         allow_retry = TRUE, 
         correct = "The quantile of order 50%, or middle point, of $\\{0, \\dots, 100, \\}$ is indeed $51$ as there are exactly 50 values before it and 50 values after it.")
```
