...
ggplot(babynames %>% filter(name %in% top_20)) +
  geom_point(aes(x = year, y = prop)) +
  labs(title = "Popularity of the 20 most popular names in the data set")
```
...
ggplot(babynames %>% filter(name %in% top_20)) +
  geom_line(aes(x = year, y = prop)) +
  labs(title = "Popularity of of the 20 most popular names in the data set")
```
